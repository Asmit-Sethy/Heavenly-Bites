...
const Cart = () => {
  ...
  const handlePayment = async () => {
    ...
    try {
      ...
      console.log("Checkout API status:", res.status, "body:", body);
      ...
      <div className="p-2 md:p-4">
        ...
        {productCartItem[0] ? (
          <div className="my-4 flex gap-6">
            ...
            <div className="w-full h-48 max-w-3xl bg-blue-100 ml-auto">
              <h2 className="bg-blue-400 font-bold text-white p-2 text-xl">
                Overview
              </h2>
              <div className="flex w-full py-2 text-lg border-b">
                <p className="px-2 font-medium">Total Items:</p>
              ...
              <div className="flex w-full py-3 text-lg border-b">
                <p className="font-medium px-2">To Pay:</p>
                <p className="ml-auto w-32 font-bold px-2">
                  <span className="text-red-500">₹</span>
                  {totalPrice}
                </p>
              </div>
              <button
                className="bg-orange-600 mt-25 w-full text-xl rounded-full font-bold py-2 text-white hover:bg-green-500"
